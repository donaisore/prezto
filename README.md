...
2.  Clone the repository:
    ...
    ```console
    git clone --recursive https://github.com/donaisore/prezto.git "${ZDOTDIR:-$HOME}/.zprezto"
    ```
    ...
    - Clone the repository:
      ...
      ```console
      git clone --recursive https://github.com/donaisore/prezto.git "${ZDOTDIR:-${XDG_CONFIG_HOME:-$HOME/.config}/zsh}/.zprezto"
      ```
